...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository, CreditCardRepository creditCardRepository, AccountCardRepository accountCardRepository) {
		return (args) -> {
			...
			Transaction transaction1 = new Transaction(account1,account1.getNumber(),TransactionType.Debit,400,"Purchase","D"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account2.getHolder(),account2.getNumber(),3900,LocalDateTime.now().minusDays(2).minusHours(3));
			Transaction transaction2 = new Transaction(account1,account1.getNumber(),TransactionType.Credit,600,"Deposit","C"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account3.getHolder(),account3.getNumber(),4500,LocalDateTime.now().minusDays(1));
			Transaction transaction3 = new Transaction(account1,account1.getNumber(),TransactionType.Credit,500,"Deposit","C"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account4.getHolder(),account4.getNumber(),5000,LocalDateTime.now());
			...
			Transaction transaction6 = new Transaction(account2,account2.getNumber(),TransactionType.Debit,600,"Withdrawal","D"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account4.getHolder(),account4.getNumber(),7500,LocalDateTime.now());
			Transaction transaction7 = new Transaction(account3,account3.getNumber(),TransactionType.Debit,800,"Transfer","D"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account1.getHolder(),account1.getNumber(),7200,LocalDateTime.now().minusDays(5).minusHours(2));
			Transaction transaction8 = new Transaction(account3,account3.getNumber(),TransactionType.Debit,200,"Purchase","D"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account2.getHolder(),account2.getNumber(),7000,LocalDateTime.now().minusDays(2).minusHours(4));
			Transaction transaction9 = new Transaction(account3,account3.getNumber(),TransactionType.Credit,1000,"Transfer","C"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account4.getHolder(),account4.getNumber(),8000,LocalDateTime.now());
			Transaction transaction10 = new Transaction(account4,account4.getNumber(),TransactionType.Debit,700,"Withdrawal","D"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account1.getHolder(),account1.getNumber(),4600,LocalDateTime.now().minusDays(5).minusHours(5));
			Transaction transaction11 = new Transaction(account4,account4.getNumber(),TransactionType.Credit,1000,"Transfer","C"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account2.getHolder(),account2.getNumber(),5600,LocalDateTime.now().minusDays(3));
			Transaction transaction12 = new Transaction(account4,account4.getNumber(),TransactionType.Credit,900,"Deposit","C"+(int)((Math.random()*(maxDescription-minDescription+1))+minDescription)+"/"+(int)((Math.random()*(maxIdDescription-minIdDescription+1))+minIdDescription),account3.getHolder(),account3.getNumber(),6500,LocalDateTime.now());
